...
VALUES
(Y, 'Ariel', 'Munroe', 00001)
(Y, 'Sasha', 'Morley', 00002)
(Y, 'Steve', "Patton", 00003)
(Y, 'Matthew', 'Forbes', 00004)
(Y, 'James', 'Brown', 00005)
(Y, 'Christina', 'Wilberforce', 00006)
(Y, 'Simone', 'Alexander', 00007)
(Y, 'Ashley', 'Smith', 00008)
(Y, 'Bejamin', 'Larson', 00009)
(Y, 'Meredy', 'Aitken', 00010)
(Y, 'Tim', 'Song', 00011)
(Y, 'Peter', 'King', 00012)
(Y, 'Julia', 'Saunders', 00013)
